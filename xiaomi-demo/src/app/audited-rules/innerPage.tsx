...
export default function AuditedRulesInnerPage() {
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  ...
                  {saving ? t('loading') : t('actions.saveRule')}
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col relative">
              ...
              <div className="flex flex-col">
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('ruleDetails.rulePrompt')}</label>
                    <textarea
                      rows={3}
                      value={aiPrompt}
              ...
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    {testLoading ? t('ruleEditor.testing') : t('ruleEditor.testRun')}
                  </button>
                </div>
              </div>
              <div className="p-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 text-sm flex-1 overflow-y-auto">
                      {testData ? (
                        ...
                        <div className="text-gray-500 text-center py-4">
                          {testLoading ? t('ruleEditor.loadingTestData') : t('ruleEditor.clickTestRun')}
                        </div>
                      )}
                    </div>
                  </div>
                  <div className="flex flex-col h-full">
                    ...
                    <div className={`rounded-lg p-3 text-sm flex-1 overflow-y-auto ${
                      ...
                      {testError ? (
                        ...
                        <div className="text-gray-500 text-center py-4">
                          {testLoading ? t('ruleEditor.runningValidation') : t('ruleEditor.clickTestExecute')}
                        </div>
                      )}
                    </div>
                  </div>
