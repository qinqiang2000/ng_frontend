...
const normalIcon = require('../commons/img/invoiceState/normal.png');
const outOfControlIcon = require('../commons/img/invoiceState/outOfControlIcon.png');
const cancelIcon = require('../commons/img/invoiceState/cancelIcon.png');
const anomalousIcon = require('../commons/img/invoiceState/anomalousIcon.png');
const abnormalIcon = require('../commons/img/invoiceState/abnormalIcon.png');
const hzdqrIcon = require('../commons/img/invoiceState/hzdqrIcon.png');
const bfhcIcon = require('../commons/img/invoiceState/bfhcIcon.png');
const qehcIcon = require('../commons/img/invoiceState/qehcIcon.png');
const hcIcon = require('../commons/img/invoiceState/hcIcon.png');
let loginInfo = {};
...
const invoiceStatusDict = {
    k0: ['正常', normalIcon],
    k1: ['已失控', outOfControlIcon],
    k2: ['已作废', cancelIcon],
    k3: ['已红冲', hcIcon],
    k4: ['异常发票', anomalousIcon],
    k5: ['非正常', abnormalIcon],
    k6: ['红字发票待确认', hzdqrIcon],
    k7: ['部分红冲', bfhcIcon],
    k8: ['全额红冲', qehcIcon]
};
    ...
    return (
        invoiceStatusInfo.length > 1 ? (
            <Tooltip placement='bottom' title={invoiceStatusInfo[0]}>
                <img className='errIcon' style={{ marginLeft: 0 }} src={invoiceStatusInfo[1]} alt='invoiceState' />
            </Tooltip>
        ) : null
    );
};
...
const vouvherHtml = (fplx) => {
    const digtalEle = [26, 27, 28, 29].indexOf(fplx) != -1;
    if (digtalEle) {
        return (
            <Tooltip title='电子会计凭证已采集'>
                <img src={require('../commons/img/eleVoucherIcon.png')} alt='' height={16} style={{ marginLeft: 10 }} />
            </Tooltip>
        );
    } else {
        return (
            <>
                ...
                <img src={require('../commons/img/signatureIcon.png')} alt='' height={16} style={{ marginLeft: 10 }} />
            </>
        );
    }
};
...
const renderCheckStatusAndWarning = (v, r) => {
    ...
    if (v === 'loading') {
        ...
        let description = r.checkDescription || r.description || '未查验';
        let checkImg = 'databf.png';
        if (v == 2) {
            description = '数据相符';
            checkImg = 'dataxf.png';
        }
        return (
            <>
                ...
                <Tooltip title={description}>
                    <img src={require('../commons/img/' + checkImg)} alt='' height={16} />
                </Tooltip>
                {
                    xbrlUrl ? (
                        vouvherHtml(parseInt(invoiceType))
                    ) : null
                }
            </>
        );
...
export const columns28 = [
    { title: '发票号码', dataIndex: 'invoiceNo', align: 'left', width: 160 },
    { title: '姓名', dataIndex: 'customerName', align: 'center', width: 84 },
    { title: '航班号', dataIndex: 'flightNum', align: 'left', width: 100 },
    { title: '出发地', dataIndex: 'placeOfDeparture', align: 'left', width: 100 },
    { title: '目的地', dataIndex: 'destination', align: 'left', width: 100 },
    { title: '开票日期', dataIndex: 'invoiceDate', align: 'center', width: 100 },
    // { title: '不含税金额', dataIndex: 'invoiceAmount', align: 'left', width: 100, render: renderNumber },
    { title: '税额', dataIndex: 'totalTaxAmount', align: 'left', width: 100, render: renderNumber },
    { title: '价税合计', dataIndex: 'totalAmount', align: 'left', width: 100, render: renderNumber },
    { title: '购方名称', dataIndex: 'buyerName', align: 'left', width: 100 },
    { title: '购方税号', dataIndex: 'buyerTaxNo', align: 'left', width: 100 },
];

//数电飞机票
export const showColumns28 = [
    { title: '发票号码', dataIndex: 'invoiceNo', align: 'left', width: 160 },
    { title: '姓名', dataIndex: 'customerName', align: 'center', width: 84 },
    { title: '身份证号', dataIndex: 'customerIdentityNum', align: 'center', width: 84 },
    // { title: '航班号', dataIndex: 'flightNum', align: 'left', width: 100 },
    { title: '出发地', dataIndex: 'placeOfDeparture', align: 'left', width: 100 },
    { title: '目的地', dataIndex: 'destination', align: 'left', width: 100 },
    { title: '乘机日期', dataIndex: 'carrierDate', align: 'center', width: 100 },
    { title: '开票日期', dataIndex: 'invoiceDate', align: 'center', width: 100 },
    { title: '票价', dataIndex: 'ticketPrice', align: 'left', width: 100, render: renderNumber },
    ...
    { title: '其他税费', dataIndex: 'otherTotalTaxAmount', align: 'left', width: 100, render: renderNumber },
    // { title: '不含税金额', dataIndex: 'invoiceAmount', align: 'left', width: 100, render: renderNumber },
    { title: '税额', dataIndex: 'totalTaxAmount', align: 'left', width: 100, render: renderNumber },
    { title: '价税合计', dataIndex: 'totalAmount', align: 'left', width: 100, render: renderNumber },
    { title: '业务单据信息', dataIndex: 'isExpenseCorrelation', align: 'center', width: 100 },
...
export const columns29 = [
    { title: '发票号码', dataIndex: 'invoiceNo', align: 'left', width: 160 },
    { title: '姓名', dataIndex: 'passengerName', align: 'center', width: 84 },
    { title: '车次', dataIndex: 'trainNum', align: 'left', width: 100 },
    { title: '出发地', dataIndex: 'stationGetOn', align: 'left', width: 100 },
...
//数电火车票
export const showColumns29 = [
    { title: '发票号码', dataIndex: 'invoiceNo', align: 'left', width: 160 },
    { title: '姓名', dataIndex: 'passengerName', align: 'center', width: 84 },
    { title: '车次', dataIndex: 'trainNum', align: 'left', width: 100 },
    { title: '出发地', dataIndex: 'stationGetOn', align: 'left', width: 100 },
    { title: '目的地', dataIndex: 'stationGetOff', align: 'left', width: 100 },
    { title: '座位等级', dataIndex: 'seat', align: 'left', width: 100 },
    { title: '开票日期', dataIndex: 'invoiceDate', align: 'center', width: 100 },
    { title: '不含税金额', dataIndex: 'invoiceAmount', align: 'left', width: 100, render: renderNumber },
    { title: '税额', dataIndex: 'totalTaxAmount', align: 'left', width: 100, render: renderNumber },
    { title: '价税合计', dataIndex: 'totalAmount', align: 'left', width: 100, render: renderNumber },
    { title: '业务单据信息', dataIndex: 'isExpenseCorrelation', align: 'center', width: 100 },
    { title: '销方名称', dataIndex: 'salerName', align: 'left', width: 100, render: (v) => { return v || '--'; } },
    { title: '销方纳税识别号', dataIndex: 'salerTaxNo', align: 'left', width: 100, render: (v) => { return v || '--'; } },
    { title: '购方名称', dataIndex: 'buyerName', align: 'left', width: 100 },
    { title: '购方纳税识别号', dataIndex: 'buyerTaxNo', align: 'left', width: 100 },
    auditTime,
    ...entryVoucherCols
...
export const columns21 = [
    { title: '缴款书号码', dataIndex: 'customDeclarationNo', key: 'customDeclarationNo', width: 100, align: 'left' },
    { title: '缴款单位一名称', dataIndex: 'deptName', key: 'deptName', width: 100, align: 'left', render: renderText },
    { title: '缴款单位二名称', dataIndex: 'secondDeptName', key: 'secondDeptName', width: 100, align: 'left', render: renderText },
...
export const columsDict = {
    ...
    k2: collectDate.concat(dkCols, columns1, dkExit, collectInfo, addedInvoiceInfo),
    ...
    k26: collectDate.concat(dkCols, columns26, dkExit, collectInfo, addedInvoiceInfo), //数电普票
    k27: collectDate.concat(dkCols, signCol, columns26, dkExit, rzCols, collectInfo, addedInvoiceInfo), //数电专票
    k28: collectDate.concat(dkCols, showColumns28, dkExit, collectInfo, addedInvoiceInfo), // 数电飞机票
    k29: collectDate.concat(dkCols, showColumns29, dkExit, collectInfo, addedInvoiceInfo), // 数电火车票
    k83: collectDate.concat(dkCols, showColumns83, collectInfo, addedInvoiceInfo), // 数电机动车
    k84: collectDate.concat(dkCols, showColumns84, collectInfo, addedInvoiceInfo), // 数电机动车
    ...
    k23: collectDate.concat(columns23, collectInfo, noAddedInvoiceInfo), // 通用机打电子发票
...
export const collectColumsDict = {
    ...
    k28: fileName.concat(dkCols, columns28, addedInvoiceInfo), //数电火车票
    k29: fileName.concat(dkCols, columns29, addedInvoiceInfo), //数电飞机票
    k83: fileName.concat(dkCols, signCol, collectColumns83, rzCols, addedInvoiceInfo), //数电机动车
    k84: fileName.concat(dkCols, signCol, collectColumns84, rzCols, addedInvoiceInfo), //数电二手车
    ...
    k23: fileName.concat(columns23, noAddedInvoiceInfo), // 通用机打电子发票
    k17: fileName.concat(columns15, noAddedInvoiceInfo), // 过路过桥费
    k21: fileName.concat(columns21, noAddedInvoiceInfo), //
    k24: fileName.concat(columns24, noAddedInvoiceInfo), //
...
export const waitCollectColumsDict = {
    ...
    k28: tipCol.concat(fileName, columns28, awaitAddedInvoiceInfo), //数电火车票
    k29: tipCol.concat(fileName, columns29, awaitAddedInvoiceInfo), //数电飞机票
    k83: tipCol.concat(fileName, columns83, awaitAddedInvoiceInfo), //数电机动车
    k84: tipCol.concat(fileName, columns84, awaitAddedInvoiceInfo), //数电二手车
    ...
    k23: tipCol.concat(fileName, columns23, noAddedInvoiceInfo), // 通用机打电子发票
    k17: tipCol.concat(fileName, columns15, noAddedInvoiceInfo), // 过路过桥费
    k21: tipCol.concat(fileName, columns21, noAddedInvoiceInfo), //
    k24: tipCol.concat(fileName, columns24, noAddedInvoiceInfo), //
...
export const collectorColums = [
    { title: '序号', dataIndex: 'sort', align: 'left', width: 80, render: (t, r, i) => i + 1 },
    { title: '采集人名称', dataIndex: 'collectorName', align: 'left', width: 110, render: (t) => t || '--' },
    { title: '采集人手机号', dataIndex: 'collectorPhone', align: 'left', width: 80, render: (t) => t || '--' },
    { title: '采集时间', dataIndex: 'collectTime', align: 'left', width: 110 }
]
