...
const renderInvocieStatus = function(v) {
    if (typeof v === 'undefined' || v === '') {
        ...
        if (v === 0) {
            ...
            return <span className='red'>部分冲红</span>;
        } else if (v === 8) {
            return <span className='red'>全额冲红</span>;
        } else {
            return '--';
        }
    }
                    ...
                    return (
                        <div style={{ textAlign: 'justify' }}>
                            <p style={{ marginBottom: 5 }}>
                                ...
                                将“有效税额”调整为“可抵扣税额”，且不允许人工修改和编辑。针对数电发票（增值税专用发票），系统自动计算其红冲剩余税额作为“可抵扣税额”，并支持“可抵扣税额”勾选。
                            </p>
...
const customDkGxInvoiceCols = [
    ...
    { title: '缴款单位一名称', dataIndex: 'deptName', align: 'left', render, width: 300 },
