...
function OrderTree (props) {
    ...
    return (
        <div>
            ...
            <div className='tabs-render' style={{ height: `calc(100vh - ${otherHeight}px - 38px - ${isShowStatistics ? 70 : 0}px)` }}>
                {modeList.find(item => item.key === activeTab).render}
            </div>
            {isShowStatistics && (
