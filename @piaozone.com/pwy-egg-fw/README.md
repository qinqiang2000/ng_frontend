...
## 安装
```
$ npm install @piaozone.com/pwy-egg-fw --registry=http://172.18.1.117:7001
//或者
$ cnpm install @piaozone.com/pwy-egg-fw--registry=http://172.18.1.117:7001
```
...
"egg": {
	"framework": "@piaozone.com/pwy-egg-fw"
}
