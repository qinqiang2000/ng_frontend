...
function TrainBill(props) {
    ...
    const colsInfo = createTableCols([
        ...
        { title: '票号', key: 'printingSequenceNo', width: 100 },
        { title: '车次', key: 'trainNum', width: 100 },
        { title: '价税合计', key: 'totalAmount', type: 'number', width: 120 },
        { title: '乘车日期', key: 'invoiceDate', width: 100 },
        ...
        { title: '座位类型', dataIndex: 'seat', width: 100 },
