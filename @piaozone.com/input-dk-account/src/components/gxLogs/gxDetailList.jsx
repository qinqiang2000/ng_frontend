...
import './dkgxErrList.less';
import { kdRequest, tools } from '@piaozone.com/utils';
import { confirm } from '../commons/antdModal';
import { getGxInfo, renderInvoiceType } from './gxInfoTool';
import { renderIndex, render, renderGlzt, renderGxFlag } from '../commons/renderTools';
...
class DkgxErrList extends React.Component {
    ...
    render() {
        ...
        const dkGxInvoiceCols = [
            { title: '序号', dataIndex: 'indexNumber', align: 'center', width: 60, render: (v, r, i) => renderIndex(i, page, pageSize) },
