...
class CurDktjQd extends React.Component {
    ...
    fetchList = (c, size = this.state.pageSize) => {
        const fpdkType = this.props.govOperate.fpdkType || 1;
        ...
        if (fpdkType === 1 || fpdkType === 2) {
            ...
            const taxPeriodDate = moment(this.props.tjyf, 'YYYYMM');
            this.searchOpt = {
                id,
                rzzt: '1',
                gxzt: '-1',
                ...
                fplx: '-1',
                fply,
                rq_q: taxPeriodDate.format('YYYY-MM-01'),
                rq_z: taxPeriodDate.endOf('month').format('YYYY-MM-DD'),
                qrrzrq_q,
                qrrzrq_z,
                pageSize: size
            };
            ...
            <div className='curDktjqd' style={{ display: showFlag ? 'block' : 'none' }}>
                <div className='titleTop clearfix'>
                    ...
                    <div className='floatRight'>
                        {
                            activeKey === '1' || (activeKey === '2' && (fpdkType === 1 || fpdkType === 3)) ? (
