...
class AddedTaxBill extends BaseBill {
    ...
    render() {
        ...
        const { buyerTaxNo = '', invoiceCode = '', invoiceNo = '', invoiceDate = '', checkCode = '', totalAmount = '', salerName = '', salerTaxNo = '', buyerName = '', totalTaxAmount = '', invoiceAmount = '' } = billData;
        ...
        } else if ([2, 4].indexOf(invoiceType) != -1) {
                    ...
                    <div>
                        ...
                        <div className='inputItems' ref='inputItems'>
                            ...
                            <div className='clearfix'>
                                ...
                                {
                                    invoiceType == 1 || invoiceType == 3 || invoiceType == 15 ? (
                                        <>
                                            <div className='inputItem floatLeft paddLeft90'>
                            ...
                            <div className='clearfix'>
                                {
                                    invoiceType == 1 || invoiceType == 3 || invoiceType == 15 ? (
                                        ...
                                        invoiceType == 2 || invoiceType == 4 || invoiceType == 5 ? (
                                            <>
                                                <div className='inputItem floatLeft paddLeft90'>
                                                    <label className='require'>购方名称：</label>
                                                    <Input type='text' disabled={disabledEdit} value={buyerName} onChange={(e) => this.setState({ billData: { ...billData, buyerName: e.target.value.trim() } })} />
