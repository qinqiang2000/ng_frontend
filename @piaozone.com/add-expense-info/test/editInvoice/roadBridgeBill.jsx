...
class TrafficBill extends BaseBill {
    ...
    render() {
        ...
        let disabled = !invoiceNo || !invoiceDate || !totalAmount || !(invoiceCode || exit);
                ...
                <ScrollWrapper height={this.props.clientHeight - 100}>
                    <div>
                        ...
                        <div className='inputItems' ref='inputItems'>
                            <div className='tip'>备注：发票代码、出口不能同时为空。</div>
                            ...
                            <div className='clearfix'>
                                ...
                                <div className='inputItem floatLeft'>
                                    ...
                                    <TimePicker
                                        ...
                                        placeholder='选择乘车时间'
                                        format='HH:mm'
                                        onChange={(date) => this.setState({ billData: { ...billData, time: date ? date.format('HH:mm') : '' } })}
