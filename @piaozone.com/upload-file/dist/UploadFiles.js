...
function _upload() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(url, files) {
    var opt,
        fileQuality,
        fileLimitWidth,
        fileLimitHeight,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            fileQuality = opt.fileQuality, fileLimitWidth = opt.fileLimitWidth, fileLimitHeight = opt.fileLimitHeight, fileLimitPixel = opt.fileLimitPixel, fileLimitSize = opt.fileLimitSize, _opt$uploadData = opt.uploadData, uploadData = _opt$uploadData === void 0 ? {} : _opt$uploadData, _opt$fieldName = opt.fieldName, fieldName = _opt$fieldName === void 0 ? 'file' : _opt$fieldName, _opt$stepUploadFinish = opt.stepUploadFinish, stepUploadFinish = _opt$stepUploadFinish === void 0 ? function (f) {
              return f;
            } : _opt$stepUploadFinish, _opt$uploadStart = opt.uploadStart, uploadStart = _opt$uploadStart === void 0 ? function (f) {
              return f;
            } : _opt$uploadStart, _opt$uploadFinish = opt.uploadFinish, uploadFinish = _opt$uploadFinish === void 0 ? function (f) {
              return f;
            } : _opt$uploadFinish, _opt$accept = opt.accept, accept = _opt$accept === void 0 ? '' : _opt$accept;
            compressOpt = {
            ...
            keyNames = Object.keys(uploadData);
            targetFiles = [];
            i = 0;
          ...
          case 27:
            ...
            _context.prev = 28;
            _context.next = 31;
            return uploadStart(targetFiles);
          ...
          case 33:
            ...
            console.warn('uploadStart 回调异常', _context.t0);

          case 36:
            _i = 0;

          case 37:
            if (!(_i < targetFiles.length)) {
              _context.next = 61;
              break;
            }

            _curFile = targetFiles[_i].file;
            _curUid = targetFiles[_i].uid;
            _context.next = 42;
            return Object(_piaozone_com_process_image__WEBPACK_IMPORTED_MODULE_0__["compressImgFile"])(_curFile, compressOpt);
          ...
          case 42:
            ...
            _context.next = 46;
            return stepUploadFinish(_objectSpread({}, res, {
              file: _curFile,
          ...
          case 48:
            ...
            _context.next = 55;
            return uploadBackend(url, formData);

          case 55:
            resUpload = _context.sent;
            _context.next = 58;
            return stepUploadFinish(_objectSpread({}, resUpload, {
              file: _curFile,
              localUrl: localUrl,
              uid: _curUid
            }));
