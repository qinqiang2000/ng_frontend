...
export const fpyInvoiceTypes = [4, 12, 3, 1, 5, 13, 15, 2];
export const govInvoiceTypes = ['01', '03', '04', '10', '11', '15', '14', '08'];
export const jxxTypes = [1, 2];

const invoiceTypeNames = ['增值税专用发票', '机动车销售统一发票', '增值税普通发票', '增值税普通发票（电子)', '增值税普通发票（卷票）', '二手车销售统一发发票', '通行费电子发票', '增值税专用发票（电子）'];
