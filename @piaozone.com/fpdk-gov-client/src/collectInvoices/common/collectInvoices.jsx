            ...
            <div className='plFpCheck'>
                <div className='clearfix btns' style={{ padding: '0 20px 10px 20px', boxSizing: 'border-box', marginBottom: 0 }}>
                    <div className='floatLeft'>
                        ...
                        <Upload {...this.getUploadProps('.pdf,.PDF', 'allEle')} className='inlineBlock' style={{ position: 'relative' }}>
                            <Tooltip placement='bottomLeft' title='全面数字化的电子发票试点请上传发票PDF版式文件，不支持图片或扫描PDF'>
                                <Button type='primary' style={{ marginRight: 16, fontSize: 12, padding: '0 8px' }}>上传全电票PDF</Button>
                            </Tooltip>
                        </Upload>
                    ...
                    </div>
                    {
                        recodeUploadedList.length != 0 || recodeUploadFailList.length != 0 ? (
                            <div style={{ height: 40, lineHeight: '40px', position: 'relative' }}>
                                ...
                                <Tooltip placement='topLeft' title='仅限于文件上传和上传全电票PDF'>
                                    <Button
                                        type='primary'
