                    ...
                    <tr>
                        <td colSpan='5'>
                            ...
                            >
                                <tbody>
                                    <tr id='tab_head_dzfp'>
                                        <td className='align_center borderRight' width='30%'>项目名称</td>
                                        <td className='align_center borderRight' width='10%'>车牌号</td>
                                        <td className='align_center borderRight' width='5%'>类型</td>
                                        <td className='align_center borderRight' width='10%'>通行日期起</td>
                                        <td className='align_center borderRight' width='10%'>通行日期止</td>
                                        ...
                                        items.map((item, i) => {
                                            return (
                                                <tr height='40px' key={i}>
                                                    ...
                                                    <td className='align_left borderRight'>
                                                        <span className='content_td_blue'>{item.vehPlate || ''}</span>
                                                    </td>
                                                    <td className='align_left borderRight'>
                                                        <span className='content_td_blue'>{item.specModel || ''}</span>
                                                    </td>
                                                    <td className='align_left borderRight'>
                                                        <span className='content_td_blue'>{formatTime(item.startDate)}</span>
                                                    </td>
                                                    <td className='align_left borderRight'>
                                                        <span className='content_td_blue'>{formatTime(item.endDate)}</span>
                                                    </td>
...
TXFInvoice.propTypes = {
    info: PropTypes.object
};

export default TXFInvoice;