...
import * as govLogins from '../govLoginLibs/ningbo';

const eUrl = 'https://etax.ningbo.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.ningbo.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.ningbo.chinatax.gov.cn/xxmh/html/index.html';
const redirectURI = 'https://etax.ningbo.chinatax.gov.cn/login-web/api/third/sso/login/redirect?qd=kexin&channelId=web&goto=30010666';

export class NingboLoginService extends BaseService {
    ...
    async tryLogin(loginData) {
        ...
        if (!nt || !nt.nightmareWindow.win) {
            ...
            const ntRes = await ctx.service.ntTools.getEtaxPage(eUrl, {
                ...
                ignoreGotoError: true,
                partition: 'persist:' + cityPageId
                // partition: cityPageId + roleText + (+new Date()),
                // headers: {
