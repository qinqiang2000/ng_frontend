...
import * as govLogins from '../govLoginLibs/heilongjiang';

const eUrl = 'https://etax.heilongjiang.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.heilongjiang.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.heilongjiang.chinatax.gov.cn';
const redirectURI = 'https://etax.heilongjiang.chinatax.gov.cn/sys/xtgl/Cl/kxlogin';
export class HeilongjiangLoginService extends BaseService {
    ...
    async login(opt: any) {
        ...
        if (stepTwoRes && stepTwoRes.data?.isLogin) {
            ...
            if (stepTwoRes.data?.isFinish) {
                ctx.service.log.info('stepTwoRes res isFinish');
