...
import * as govLogins from '../govLoginLibs/shanxi';

const eUrl = 'https://etax.shanxi.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.shanxi.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.shanxi.chinatax.gov.cn/login';
const redirectURI = 'https://etax.shanxi.chinatax.gov.cn/tpass/sso/loginSubmit';

export class ShanxiLoginService extends BaseService {
    // 检查登录
