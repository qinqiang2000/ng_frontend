...
import * as govLogins from '../govLoginLibs/hebei';

const eUrl = 'https://etax.hebei.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.hebei.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.hebei.chinatax.gov.cn/bszm-web/apps/views-zj/index/index.html';
const redirectURI = `${eUrl}/login-web/api/third/sso/login/redirect?qd=KEXIN&channelId=web&goto=30010666&response_type=code&state=test`;

export class HebeiLoginService extends BaseService {
