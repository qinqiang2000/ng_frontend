import * as govLogins from '../govLoginLibs/guizhou';

const eUrl = 'https://etax.guizhou.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.guizhou.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.guizhou.chinatax.gov.cn/xxmh/html/index.html?isChangeSf=true';
const redirectURI = `${eUrl}/kxsfrz-cjpt-web/tpass/tpassLogin.do?service=https%3A%2F%2Fetax.guizhou.chinatax.gov.cn/xxmh%2Fhtml%2Findex_login.html`;

export class GuizhouLoginService extends BaseService {
    ...
    async queryBillMenuIndex(nt: any, opt: any) {
        ...
        ctx.service.log.info('检查登录返回1', (+new Date()) - startTime, redirectRes);
