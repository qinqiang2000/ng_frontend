...
import * as govLogins from '../govLoginLibs/xinjiang';

const eUrl = 'https://etax.xinjiang.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.xinjiang.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.xinjiang.chinatax.gov.cn/wszx-web/bszm/apps/views/beforeLogin/indexBefore/pageIndex.html#/';
const redirectURI = `${eUrl}/login-web/api/third/sso/login/redirect?qd=kexin&channelId=web&goto=30010666`;
export class XinjiangLoginService extends BaseService {
