import * as govLogins from '../govLoginLibs/anhui';

const eUrl = 'https://etax.anhui.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.anhui.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.anhui.chinatax.gov.cn/cas/login';
const redirectURI = 'https://etax.anhui.chinatax.gov.cn/cas/kxlogin';

export class AnhuiLoginService extends BaseService {
