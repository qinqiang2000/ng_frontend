import * as govLogins from '../govLoginLibs/liaoning';

const eUrl = 'https://etax.liaoning.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.liaoning.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.liaoning.chinatax.gov.cn/sword?ctrl=LoginCtrlTmp_logout';
const redirectURI = 'https://etax.liaoning.chinatax.gov.cn/sword?ctrl=DzswjKxtxCtrl_getKxtxOauth2Token';

export class LiaoningLoginService extends BaseService {
