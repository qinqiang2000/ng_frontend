...
import * as govLogins from '../govLoginLibs/fujian';

const eUrl = 'https://etax.fujian.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.fujian.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.fujian.chinatax.gov.cn/xxmh/html/index.html';
const redirectURI = `${eUrl}/kxsfrz-cjpt-web/tpass/tpassLogin.do?service=http%3A%2F%2Fetax.fujian.chinatax.gov.cn%2Fxxmh%2Fhtml%2Findex_login.html`;

export class FujianLoginService extends BaseService {
