import * as govLogins from '../govLoginLibs/ningxia';

const eUrl = 'https://etax.ningxia.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.ningxia.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.ningxia.chinatax.gov.cn/sword?ctrl=LoginCtrlTmp_logout';
const redirectURI = 'https://etax.ningxia.chinatax.gov.cn/sword?ctrl=DzswjKxtxCtrl_getKxtxOauth2Token';

export class NingxiaLoginService extends BaseService {
