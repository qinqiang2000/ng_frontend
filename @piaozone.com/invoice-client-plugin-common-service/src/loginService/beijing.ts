...
import * as govLogins from '../govLoginLibs/beijing';

const eUrl = 'https://etax.beijing.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.beijing.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.beijing.chinatax.gov.cn/xxmh/html/index.html';
const redirectURI = 'https://etax.beijing.chinatax.gov.cn/kxsfrz-cjpt-web/tpass/tpassLogin.do';

export class BeijingLoginService extends BaseService {
