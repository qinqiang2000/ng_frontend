import * as govLogins from '../govLoginLibs/jiangxi';

const eUrl = 'https://etax.jiangxi.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.jiangxi.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.jiangxi.chinatax.gov.cn/etax/jsp/index.jsp';
const redirectURI = 'https://etax.jiangxi.chinatax.gov.cn/etax/jsp/do_tpass_login_initData.jsp';

export class JiangxiLoginService extends BaseService {
