...
import * as govLogins from '../govLoginLibs/hainan';

const eUrl = 'https://etax.hainan.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.hainan.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.hainan.chinatax.gov.cn/zjgfdzswj/main/index.html';
const redirectURI = `${eUrl}/zjgfdzswj/main/kx/skip.html?service=https://etax.hainan.chinatax.gov.cn/zjgfdzswj/main/home/wybs/index.html`;

export class HainanLoginService extends BaseService {
