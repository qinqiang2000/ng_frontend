import * as govLogins from '../govLoginLibs/xizang';

const eUrl = 'https://etax.xizang.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.xizang.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.xizang.chinatax.gov.cn:8443/sword?ctrl=LoginCtrlTmp_logout#';
const redirectURI = 'https://etax.xizang.chinatax.gov.cn:8443/sword?ctrl=DzswjKxtxCtrl_getKxtxOauth2Token';
export class XizangLoginService extends BaseService {
    ...
    async tryLogin(loginData: any) {
        ...
        let wRes = await nt.wait(govLogins.tryLoginWait, { checkClickBtn: true });
