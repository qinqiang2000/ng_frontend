...
import * as govLogins from '../govLoginLibs/henan';

const eUrl = 'https://etax.henan.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.henan.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.henan.chinatax.gov.cn/web/dzswj/ythclient/mh.html';
const redirectURI = 'https://etax.henan.chinatax.gov.cn/web/dzswj/kxyh/loginyw.html';

export class HenanLoginService extends BaseService {
    ...
    async stepOneTypes(nt, data = {}, retry = 0) {
        ...
        try {
            ...
            ctx.service.log.info('init', (+new Date()) - startTime);
            ...
            ctx.service.log.info('drayBtn retryDrayData', retryDrayData);
            ...
            const checkRes = await nt.wait(govLogins.checkStepOneLogin, data);
            ...
            ctx.service.log.info('getPhoneNumber返回', resPhone);
            return resPhone;
        } catch (error) {
    ...
    async queryBillMenuIndex(nt, opt) {
        ...
        const { companyName, szzhCompany = '', openInvoiceCompany = '', wybsItem, companyType = '03' } = redirectRes.data || {};
        return {
            ...errcodeInfo.success,
            data: {
                companyName,
