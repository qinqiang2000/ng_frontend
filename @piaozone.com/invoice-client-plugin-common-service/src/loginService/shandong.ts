import * as govLogins from '../govLoginLibs/shandong';

const eUrl = 'https://etax.shandong.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.shandong.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.shandong.chinatax.gov.cn/EnterpriseDzswjMainAction.do?activity=dzswj_out';
const redirectURI = 'https://etax.shandong.chinatax.gov.cn/KxsfrzAction.do?activity=login';
export class ShandongLoginService extends BaseService {
