...
import * as govLogins from '../govLoginLibs/yunnan';

const eUrl = 'https://etax.yunnan.chinatax.gov.cn';
const etaxBaseUrl = 'https://dppt.yunnan.chinatax.gov.cn:8443';
const eLoginUrl = 'https://etax.yunnan.chinatax.gov.cn/zjgfdzswj/main/index.html';
const redirectURI = `${eUrl}/zjgfdzswj/main/kx/skip.html?service=${eUrl}/zjgfdzswj/main/home/wdxx/index.html`;
export class YunnanLoginService extends BaseService {
    ...
    async queryBillMenuIndex(nt, opt) {
        ...
        // 点击我要办税
        await nt.click('.css-sub-menu .sub-menu-nav a:nth-child(2)');
