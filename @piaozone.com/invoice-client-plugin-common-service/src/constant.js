...
export const simulateClickPreKey = 'simulateClick';
...
// 数电账号 密码错误
export const etaxAccountPasswdErrorPreKey = 'etax-accountPasswd-error-';

// 数电账号 验证码错误
export const etaxShortMsgCodeErrorPreKey = 'etax-shortMsgCode-error-';

// 数电账号 验证码获取失败
export const etaxShortMsgCodeGetFailPreKey = 'etax-shortMsgCode-get-fail-';

// 数电账号 地区验证码发送限制
export const etaxAreaShortMsgCodeSendPreKey = 'etax-area-shortMsgCode-send-';

// 数电账号 验证码频繁
export const etaxShortMsgCodeOverrunPreKey = 'etax-shortMsgCode-overrun-';

// 数电账号 地区登录限制
export const etaxAreaLoginLimitPreKey = 'etax-area-login-limit-';

export const getGovPublickKeylockPreKey = 'nt-get-public-key-lock-request-pre';
...
export const ETAX_LOGIN_OPTIONS = [
    ...
    { code: '1200', autoLogin: true, city: '天津', name: 'tianjin' },
...
export const etaxOpenApi = [
    '/fpdk/etax/open/invoice/download', // 电子税局开票文件下载
    '/fpdk/etax/bill/invoice/create', // 发票开具
    '/fpdk/etax/openInvoice/status/query', // 通过开票流水号查询30天内已经开具的发票
    '/fpdk/etax/bill/invoice/red/apply', // 红字申请单录入
    '/fpdk/etax/red/confirmBill/query', // 分页查询红字确认单
    '/fpdk/etax/red/confirmBill/detail/query', // 查询红字确认单详情
    '/fpdk/etax/openInvoice/creditLine/query', // 授信额度查询
    '/fpdk/etax/openInvoice/status/update', // 开票状态修改
    '/fpdk/etax/openInvoice/status/query', // 开票状态查询
    '/fpdk/etax/bill/invoice/redConfirmBill/revoke', // 红字申请单撤销
    '/fpdk/etax/bill/invoice/redConfirmBill/update', // 红字申请单确认或拒绝
    '/fpdk/etax/paper/invoice/cancel' // 数电纸质发票作废
];