...
function ShowCollectResult(props) {
    ...
    if (['k1', 'k3', 'k4', 'k5', 'k12', 'k13', 'k15'].indexOf(activeInvoiceType) !== -1) {
        scrollWidth = 2215;
    }
    const tableProps = {
        key: 'table',
        ...
        columns: collectColumsDict[activeInvoiceType] ? collectColumsDict[activeInvoiceType].concat(operateCol) : [],
