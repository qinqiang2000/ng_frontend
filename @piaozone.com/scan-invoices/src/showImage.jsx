...
import { cuteImage, loadImage, isShowCanvas } from '@piaozone.com/process-image';
            ...
            return (
                <div style={{ width: '100%', height: height || 450, overflow: 'hidden', position: 'relative' }}>
                    <canvas
                        ...
                        height={height ? height.toString() : '450'} style={{ position: 'absolute', left: 0, top: 0 }}
                    />
                    {
                        loading ? (
...
ShowImage.propTypes = {
    ...
    redirectShowImage: PropTypes.bool,
