...
class AirBill extends BaseBill {
    ...
    render() {
        ...
        let disabled = !printNum || !electronicTicketNum || !invoiceAmount ||
                        !totalAmount || !invoiceDate || !placeOfDeparture || !destination || !customerName;
                    ...
                    <div>
                        ...
                        <div className='inputItems' ref='inputItems'>
                            ...
                            <div className='clearfix'>
                                ...
                                <div className='inputItem floatLeft'>
                                    <label className='require'>顾客姓名：</label>
                                    <Input
                                        type='text'
                                        disabled={disabledEdit}
                                        value={customerName}
                                    ...
                                    <span className='colItem colItem1'>
                                        <Input
                                            ...
                                            onChange={(e) => this.setState({
                                                billData: {
                                                    ...billData,
                                                    placeOfDeparture: e.target.value.trim()
                                                }
                                            })}
                                        />
                                    </span>
                            ...
                            <div className='clearfix'>
                                <div className='inputItem floatLeft paddLeft110'>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => this.setState({
                                            billData: {
                                                ...billData,
                                                fuelSurcharge: e.target.value.trim()
                                            }
                                        })}
                                    />
                                </div>
                                <div className='inputItem floatLeft'>
                                    ...
                                    <Select
                                        ...
                                        style={{ width: '100%' }}
                                        onChange={(v) => this.setState({
                                            billData: { ...billData, seatGrade: v }
                                        })}
                                        disabled={disabledEdit}
                                    >
                                        <Option value=''>请选择坐位等级</Option>
                                        <Option value='F'>头等舱</Option>
                                        <Option value='C'>公务舱（商务舱）</Option>
                                        <Option value='Y'>普通舱（经济舱）</Option>
                                    </Select>
                                </div>
                                ...
                                <div className='inputItem floatLeft'>
                                    ...
                                    <Input
                                        type='text'
                                        disabled={disabledEdit}
                                        value={airportConstructionFee}
                                        onChange={(e) => this.setState({
                                            billData: {
                                                ...billData,
                                                airportConstructionFee: e.target.value.trim()
                                            }
                                        })}
                                    />
                                </div>
                            ...
                            <div className='clearfix'>
                                <div className='inputItem floatLeft paddLeft110'>
                                    ...
                                    <Input
                                        type='text'
                                        disabled={disabledEdit}
                                        value={otherTotalTaxAmount}
                                        onChange={(e) => this.setState({
                                            billData: {
                                                ...billData,
                                                otherTotalTaxAmount: e.target.value.trim()
                                            }
                                        })}
                                    />
                                </div>
                                ...
                                <div className='inputItem floatLeft'>
                                    ...
                                    <Input
                                        type='text'
                                        disabled={disabledEdit}
                                        value={isNaN(parseFloat(insurancePremium)) ? '' : insurancePremium}
                                        onChange={(e) => this.setState({
                                            billData: {
                                                ...billData,
                            ...
                            <div className='clearfix'>
                                <div className='inputItem floatLeft paddLeft110'>
                                    ...
                                    <Select
                                        ...
                                        style={{ width: 190 }}
                                        onChange={(v) => this.setState({
                                            billData: { ...billData, internationalFlag: v }
                                        })}
                                        disabled={disabledEdit}
                                    >
                                        {
