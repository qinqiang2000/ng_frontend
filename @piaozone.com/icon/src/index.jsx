...
function Icon(props = {}) {
    const {onClick, type, style, rotate} = props;
    return (
        <i
            aria-label={'icon: ' + type}
            style={style}
            tabIndex='-1'
            className={'pwyicon pwyicon-' + type}
            onClick={onClick}
        >
            <svg viewBox='64 64 896 896' focusable='false' className='' data-icon={type} width='1em' height='1em' fill='currentColor' aria-hidden='true' style={{ transform: 'rotate(' + rotate + 'deg)' }}>
                {
                    type === 'undo' ? (
