(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pwyToolTip"] = factory();
	else
		root["pwyToolTip"] = factory();
})(window, function() {
...
var __pwyToolTip = function __pwyToolTip(_ref) {
  var _ref$selector = _ref.selector,
      selector = _ref$selector === void 0 ? '' : _ref$selector,
      _ref$tipOuterCls = _ref.tipOuterCls,
      tipOuterCls = _ref$tipOuterCls === void 0 ? 'outerPwyTip' : _ref$tipOuterCls,
      _ref$tipsCls = _ref.tipsCls,
      tipsCls = _ref$tipsCls === void 0 ? 'tipsText' : _ref$tipsCls;
  ...
  var getHtml = function getHtml() {
    var tipHtml = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var id = arguments.length > 1 ? arguments[1] : undefined;
    return "\n        <div style=\"position: absolute; top: 0px; left: 0px; width: 100%;z-index:9999 !important\" class=\"".concat(tipOuterCls, "\" id=\"").concat(id, "\">\n            <div class=\"pwyToolTip\" style=\"left: 0; top: 0;visibility:hidden;\">\n                <div class=\"pwy-tooltip-content\">\n                    <div class=\"pwy-tooltip-arrow\"></div>\n                    <div class=\"pwy-tooltip-inner\" style=\"max-height: 300px;overflow: auto;\">\n                        <div style=\"padding: 10px;\">\n                            ").concat(tipHtml, "\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>");
  };

  var startTime; // 鼠标操作提示开始时间

  var endTime; // 鼠标操作提示结束时间

  var isEnter = false; // 是否进入onMouseenter事件
  ...
  var selectorWidth = 0; // 元素宽度

  var selectorHeight = 0; // 元素高度
  ...
  var onMouseenter = function onMouseenter(e) {
    ...
    var el = $(e.target);
    var html = el.closest(selector).find('.' + tipsCls).html();
    var itemWidth = el.width();
    var itemHeight = el.height();
    var offset = el.offset();
    var arrowCls = 'leftTop';
    var isBottom = false;
    var isRight = false;
    var pos = {
      x: offset.left,
    ...
    var curHtml = getHtml(html, uid);
    $('body').append(curHtml);
    $('#' + uid + '.' + tipsCls).css({
      display: 'block'
    });
    var contentEl = $('#' + uid + ' .pwy-tooltip-content');
    var boxWidth = contentEl.width();
    var boxHeight = contentEl.height();
  ...
  var onMousemove = function onMousemove(e) {
    ...
    var el = $(e.target);
    var tipEle = el.closest(selector);
    var tipBox = el.closest('.pwyToolTip');
    var duration = endTime - startTime;
    var moveX = Math.abs(e.pageX - startX);
    var moveY = Math.abs(e.pageY - startY); // 如果没有再指定的元素范围内

    if (tipEle.length === 0 && tipBox.length === 0) {
      // 移动距离比较小忽略
      if (moveX < 15 && moveY < 15) {
        endTime = +new Date(); // 移动距离大于显示图标，或者移动时长超过800ms，
...
var pwyToolTip = function initToolTip() {
  var isInit = false;
...
/* harmony default export */ __webpack_exports__["default"] = (pwyToolTip);
