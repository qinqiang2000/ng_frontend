...
module.exports = {
    ...
    useHash: true,
    library: 'swjgFpdk', // 'UploadFiles', // // 指定类库名,主要用于直接引用的方式(比如使用script 标签)
    libraryExport: 'exports', //libraryExport: 'default', // 和具体export有关系，如果使用了export default导出模块这里最好使用default，否则不要添加这个配置
    libraryTarget: 'umd', // 定义打包方式Universal Module Definition,同时支持在CommonJS、AMD和全局变量使用
    entry: {
        swjgFpdkV4: path.join(srcDir, 'index.js'), // 可以修改打包出来的名称
        // MultiInvoicesUpload: path.join(srcDir, 'multiInvoicesUpload.js') // 可以修改打包出来的名称
    }
};
