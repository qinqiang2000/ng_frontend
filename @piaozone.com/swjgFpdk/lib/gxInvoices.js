...
export var gx = function () {
    var _ref3 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(gxInfos) {
        var passwd, ptPasswd, fpdm, fphm, kprq, zt, newZt, fpdms, i, _i, loginRes, ymbb, _loginRes$data, baseUrl, companyType, taxNo, govToken, res, _res2, publickey, ts, searchParam, jsonData, key1, resultTip, minMaxDate, fpcyRes, findResult;
